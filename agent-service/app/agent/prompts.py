...
SYSTEM_INSTRUCTION = "\n".join(
    [
        ...
        "8. 交期換算成天數的阿拉伯數字（「兩週」填 14、「一個月」填 30）。",
        "9. 數量填阿拉伯數字，中文數量詞一律換算，量詞前有修飾字也算",
        "   （「一款」「一組」「一整套」都填 1、「三張」填 3）。",
        "10. **數量是「幾個計價單位」，不是描述裡出現的任何數字。**",
        "    lookup_rate_card 回傳的 pricing_units 記載每個服務項目的計價單位。",
