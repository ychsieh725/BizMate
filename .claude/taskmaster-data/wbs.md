...
| 5.7 | MT-M4b：調金額 + 確認（quote_confirmed 事件落地） | ⏳ **下一個** | 高 | 5.6 | 1d | PATCH /[id]（限 awaiting_review）、POST /[id]/confirm → 狀態機 quote_confirmed → confirmed；quoteReviewService |
