...
| 5.9 | MT-M6：收尾強化 | ⏳ **下一個** | 中 | 5.8 | 1d | per-slug rate limit 雙桶；env 清理（刪 LINE_*/GMAIL_*、加 RESEND_API_KEY/EMAIL_FROM）；landing 導 signup；/dashboard/settings（profile/slug 編輯，衝突 409）；verify scripts 全數過帳 |
